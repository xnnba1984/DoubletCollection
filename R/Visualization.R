...
#'
#' @examples
#' Plot_Boxplot(result = result.auprc, measurement = 'AUPRC')
#' Plot_Boxplot(result = result.auroc, measurement = 'AUROC')
#'
Plot_Boxplot<- function(result, measurement){
...
#'
Plot_Lineplot<- function(result, type, measurement){
...
#'
Plot_Barplot <- function(result, measurement){
...
#'
Plot_Barplot_temp <- function(result, title){
...
#'
Plot_Heatmap<- function(result, cluster){
...
#'
Plot_Lineplot_Distributed<- function(result, data, measurement){
